...
#define OV7670_REG_SCALING_PCLK_DELAY (0xA2) /* Pixel clock delay */
...
#define OV7670_FORMAT_MASK (0b101)
#define OV7670_FORMAT_YUV  (0b000)
#define OV7670_FORMAT_RGB  (0b100)
#define OV7670_FORMAT_BAY  (0b001) // Bayer RAW
#define OV7670_FORMAT_PBAY (0b101) // Processed Bayer RAW

#define OV7670_FORMAT_RGB_MASK   (0b110000)
#define OV7670_FORMAT_RGB_NORMAL (0b000000)
#define OV7670_FORMAT_RGB_565    (0b010000)
#define OV7670_FORMAT_RGB_555    (0b110000)
...
#define OV7670_TESTPATTERN_MASK      (0b1000000)
#define OV7670_TESTPATTERN_ENABLE_MASK (0b10)


#define OV7670_COM3_DCW_MASK       (0b00100)
#define OV7670_COM14_PCLK_DIV_MASK (0b00111)
#define OV7670_COM14_DCW_MASK      (0b10000)
#define OV7670_COM14_SCALING_MASK  (0b01000)

#define OV7670_SCALINGXSC_SCALING_MASK (0b01111111)
#define OV7670_SCALINGYSC_SCALING_MASK (0b01111111)

#define OV7670_QVGA_COM3  (0x04)
#define OV7670_QVGA_COM14 (0x1A)
